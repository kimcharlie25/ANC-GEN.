      ...
      <div className={`bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group animate-scale-in border border-gray-100 ${!item.available ? 'opacity-60' : ''}`}>
        ...
        <div className="relative h-48 bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
              ...
              <div className="bg-primary text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg animate-pulse">
                SALE
              </div>
            )}
            {item.popular && (
          ...
          {!item.available && (
            <div className="absolute top-3 right-3 bg-black text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
              UNAVAILABLE
            </div>
          )}
          ...
          {item.isOnDiscount && item.discountPrice && (
            <div className="absolute bottom-3 right-3 bg-white/90 backdrop-blur-sm text-primary text-xs font-bold px-2 py-1 rounded-full shadow-lg">
            ...
            <div className="flex-shrink-0">
              {!item.available ? (
                ...
                <button
                  ...
                  className="bg-primary text-white px-6 py-2.5 rounded-xl hover:bg-primary/90 transition-all duration-200 transform hover:scale-105 font-medium text-sm shadow-lg hover:shadow-xl"
                >
          ...
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-6">
                            ...
                            <div className="flex items-center space-x-2">
                              {selectedAddOns.find(a => a.id === addOn.id) ? (
                                ...
                                <button
                                  ...
                                  className="flex items-center space-x-1 px-4 py-2 bg-primary text-white rounded-xl hover:bg-primary/90 transition-all duration-200 text-sm font-medium shadow-lg"
                                >
              ...
              <button
                ...
                className="w-full bg-primary text-white py-4 rounded-xl hover:bg-primary/90 transition-all duration-200 font-semibold flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
